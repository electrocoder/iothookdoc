/*
    ...
    */
    ...
    void loop () {
      ...
      // # 684 - Mobile Network Data
      // https://iothook.com/en/device/settings/684/
      // https://iothook.com/en/device/data/684/
      data = "{\"api_key\":\"4fafb9def3e8a41c27fac70d\",\"field_1\":" + String(random(0, 100)) + "}";
